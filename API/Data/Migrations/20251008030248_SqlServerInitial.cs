        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekDays = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsYearModule = table.Column<bool>(type: "bit", nullable: false),
                    ClassVenue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeekDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartTimes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EndTimes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndTime = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
